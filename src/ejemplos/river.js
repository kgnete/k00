...
export default class River extends Component {
  ...
  getOption = () => {
    return {
      ...
      backgroundColor: new echarts
        .graphic
        .RadialGradient(0.62, 0.45, 1, [
          {
            offset: 0,
            color: '#fe9e80'
          }, {
          ...
          data: [
            {
              ...
              symbol: 'path://M27.310007,2.749997l22.5,0c-2.485281,0 -4.5,14.326891 -4.5,32.000002c0,17' +
                  '.673113 2.014718,32 4.5,32l-22.5,0l0,0c-2.485281,0 -4.5,-14.326889 -4.5,-32c0,-1' +
                  '7.673111 2.014718,-32.000002 4.5,-32.000002z M12.75,70.184998l47,0l-11,10l-30,-1' +
                  'l-6,-9z'
            }, {
              //boat shadow
              symbolSize: [
